...
from ediview.models import EdiMessage,EdiMessageItem,Record,Field
...
class EdiMessageAdmin(admin.ModelAdmin):
    list_display = ['name']
    inlines = [RecordInline]
admin.site.register(EdiMessage, EdiMessageAdmin)

class EdiMessageItemAdmin(admin.ModelAdmin):
    list_display = ['object_id']
admin.site.register(EdiMessageItem, EdiMessageItemAdmin)
...
class RecordAdmin(TreeNodeModelAdmin):
    ...
    #form = TreeNodeForm
    list_display = ['name','value','edimessage']
    list_editable = ['value']
    ordering = ['edimessage','id']
    list_filter = ['edimessage']
    search_fields = ['edimessage__name__icontains']
