...
class Channel(models.Model):
    ...
    rsrv1 = models.CharField(max_length=35,null=True,blank=True,verbose_name='Max failures',help_text='Max number of connection failures of incommunication before this is reported as a processerror (default: direct report).')      #added 20100501 #20140315: used as max_com
