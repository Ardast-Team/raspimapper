...
def document(request,*kw,**kwargs):
    ...
    query = models.Transaction.objects.filter(django.db.models.Q(status=SPLITUP)|django.db.models.Q(status=TRANSLATED))
    pquery = viewlib.filterquery(query,cleaned_data)
...
def result_from_djangoq(task):
    ...
    #return django.shortcuts.redirect('/bots/add_async_message',kwargs={'task_id':task})
